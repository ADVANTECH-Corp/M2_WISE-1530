...
int Main_Menu(int index, char *string, int len, void *printer) {
	...
	simple_cmds cmds[] = {
			{ AP_NAME " Verification Test" /*title*/,  		NULL,NULL },
//			{ "Wifi MAC Address (Read Only)",				0,GetWifiMac },
			{ "I/O Function Test",				        	0,IOTest_Menu },
//			{ "Wifi Test",									0,WifiTest_Menu },
			{ NULL,											NULL,NULL }
	};
